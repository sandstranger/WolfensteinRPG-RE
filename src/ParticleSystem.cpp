...
ParticleEmitter::ParticleEmitter() {
	memset(this, 0, sizeof(ParticleEmitter));
}
            ...
            if (n24 < -65536 || n24 > 65536 || n25 > 65536 || n25 < -65536) {
                ...
                if (!b) {
                    ...
                    if (n28 - 1 >= 0) {
                        ...
                        graphics->drawRegion(systems->imgGibs[this->gibType], (3 - n28) * 48, n23 * 48, 48, 48, n26, n27, 3| 128, ParticleSystem::rotationSequence[n29], 0);
                    }
                }
            }
            n2 = i;
...
ParticleSystem::ParticleSystem() {
	memset(this, 0, sizeof(ParticleSystem));
}
